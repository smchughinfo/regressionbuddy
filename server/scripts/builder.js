...
const buildIndex = () => {
    ...
    <p class="lead">Welcome to regressionbuddy.com, the cool new math website all the kids are talking about. The current go live date is 2/18/18. In the meantime you can help improve the quality of this site by participating in its <a href="/review">first review</a>.</p>\
    </p>\
  </div>`;
